...
d3 = function() {
    ...
    function d(n) {
        for (var t = new f,
                 e = 0,
                 r = arguments.length; ++e < r;) t[arguments[e]] = h(t);
    ...
    function k(n) {
        return "function" == typeof n ? n: (n = da.ns.qualify(n)).local ?
            function() {
    ...
    function q(n) {
        return arguments.length || (n = da.ascending),
            function(t, e) {
    ...
    function T(n, t) {
        for (var e = 0,
                 r = n.length; r > e; e++) for (var i, u = n[e], a = 0, o = u.length; o > a; a++)(i = u[a]) && t(i, a, e);
        return n
    }
    function C(n) {
        return za(n, Oa),
    ...
    function H() {
        var n = ".dragsuppress-" + ++Ia,
            t = "touchmove" + n,
            e = "selectstart" + n,
            r = "dragstart" + n,
            i = "click" + n,
            u = da.select(ya).on(t, g).on(e, g).on(r, g),
            a = va.style,
            o = a[Ua];
        return a[Ua] = "none",
            function(t) {
    ...
    function F(n, t) {
        ...
        if (e.createSVGPoint) {
            ...
            return Va ? (r.x = t.pageX, r.y = t.pageY) : (r.x = t.clientX, r.y = t.clientY),
    ...
    function J(n, t, e) {
        return isNaN(n) && (n = 0),
        isNaN(t) && (t = 0),
            G(e, Math.cos(n *= Ka) * t, Math.sin(n) * t)
    }
    function G(n, t, e) {
        return new K(n, t, e)
    }
    ...
    function Q(n, t, e) {
        ...
        return i = tt(i) * eo,
            r = tt(r) * ro,
            u = tt(u) * io,
            it(rt(3.2404542 * i - 1.5371385 * r - .4985314 * u), rt( - .969266 * i + 1.8760108 * r + .041556 * u), rt(.0556434 * i - .2040259 * r + 1.0572252 * u))
    }
    function nt(n, t, e) {
    ...
    function lt(n, t, e) {
        n = st(n),
            t = st(t),
            e = st(e);
        var r = et((.4124564 * n + .3575761 * t + .1804375 * e) / eo),
            i = et((.2126729 * n + .7151522 * t + .072175 * e) / ro),
            u = et((.0193339 * n + .119192 * t + .9503041 * e) / io);
    ...
    function dt(n, t, e, r) {
        ...
        var u = {},
            a = da.dispatch("progress", "load", "error"),
            o = {},
            c = new XMLHttpRequest,
            l = null;
        return ! ya.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest),
    ...
    function yt() {
        for (var n = Date.now(), t = co; t;) n >= t.time && (t.flush = t.callback(n - t.time)),
            t = t.next;
        return n
    }
    function Mt() {
        for (var n, t = co,
                 e = 1 / 0; t;) t.flush ? t = n ? n.next = t.next: co = t.next: (t.time < e && (e = t.time), t = (n = t).next);
        return lo = n,
            e
    }
    function xt(n, t) {
                ...
                m = {
                    ...
                    polygonEnd: function() {
                        m.point = u,
                            ...
                            m.lineEnd = c,
                            h = da.merge(h),
                            h.length ? It(h, $t, null, e, i) : r(g) && (i.lineStart(), e(null, null, 1, i), i.lineEnd()),
                            i.polygonEnd(),
                            h = g = null
                    },
                    sphere: function() {
    ...
    function Jt(n) {
        ...
        return {
            ...
            point: function(u, a) {
                var o = u > 0 ? Wa: -Wa,
                    c = Math.abs(u - e);
                Math.abs(c - Wa) < Ja ? (n.point(e, r = (r + a) / 2 > 0 ? Wa / 2 : -Wa / 2), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(o, r), n.point(u, r), t = 0) : i !== o && c >= Wa && (Math.abs(e - i) < Ja && (e -= i * Ja), Math.abs(u - o) < Ja && (u -= o * Ja), r = Gt(e, r, u, a), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(o, r), t = 0),
                    n.point(e = u, r = a),
                    i = o
            },
            lineEnd: function() {
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    var g, p = [f, h],
                        d = t(f, h),
                        m = o ? d ? 0 : i(f, h) : d ? i(f + (0 > f ? Wa: -Wa), h) : 0;
                    if (!e && (c = a = d) && n.lineStart(), d !== a && (g = r(e, p), (Ht(e, g) || Ht(p, g)) && (p[0] += Ja, p[1] += Ja, d = t(p[0], p[1]))), d !== a) s = 0,
    ...
    function te(n, t, e, r) {
        ...
        return function(c) {
            ...
            function s(n) {
                for (var t = 0,
                         e = M.length,
                         r = n[1], i = 0; e > i; ++i) for (var u, a = 1,
                                                               o = M[i], c = o.length, l = o[0]; c > a; ++a) u = o[a],
                    l[1] <= r ? u[1] > r && f(l, u, n) > 0 && ++t: u[1] <= r && f(l, u, n) < 0 && --t,
                    l = u;
                return 0 !== t
            }
            function f(n, t, e) {
            ...
            function v(n, t) {
                n = Math.max( - Io, Math.min(Io, n)),
                    t = Math.max( - Io, Math.min(Io, t));
                var e = g(n, t);
                if (M && x.push([n, t]), A) b = n,
                    _ = t,
                    w = e,
                    A = !1,
            ...
            var y, M, x, b, _, w, S, E, k, A, N = c,
                ...
                T = {
                    ...
                    polygonEnd: function() {
                        c = N,
                            (y = da.merge(y)).length ? (c.polygonStart(), It(y, u, l, h, c), c.polygonEnd()) : s([n, t]) && (c.polygonStart(), c.lineStart(), h(null, null, 1, c), c.lineEnd(), c.polygonEnd()),
                            y = M = x = null
                    }
                };
            return T
        ...
        function e(t, u, a, o, c, l, s, f, h, g, p, d, m, v) {
            ...
            if (x > 4 * r && m--) {
                var b = o + g,
                    ...
                    E = Math.asin(w /= S),
                    k = Math.abs(Math.abs(w) - 1) < Ja ? (a + h) / 2 : Math.atan2(_, b),
                    A = n(k, E),
                    N = A[0],
                    q = A[1],
                    T = N - t,
                    C = q - u,
                    z = M * T - y * C; (z * z / x > r || Math.abs((y * T + M * C) / x - .5) > .3 || i > o * g + c * p + l * d) && (e(t, u, a, o, c, l, N, q, k, b /= S, _ /= S, w, m, v), v.point(N, q), e(N, q, k, b, _, w, s, f, h, g, p, d, m, v))
            }
        }
        var r = .5,
            i = Math.cos(30 * Ka),
    ...
    function Me(n, t) {
        return {
            point: function(e, r) {
                r = n(e * Ka, r * Ka),
                    e = r[0],
                    t.point(e > Wa ? e - 2 * Wa: -Wa > e ? e + 2 * Wa: e, r[1])
            },
            sphere: function() {
                t.sphere()
            },
    ...
    function _e(n) {
        return function(t, e) {
            return t += n,
                [t > Wa ? t - 2 * Wa: -Wa > t ? t + 2 * Wa: t, e]
        }
    }
    function we(n) {
        var t = _e(n);
        return t.invert = _e( - n),
            t
    }
    function Se(n, t) {
        function e(n, t) {
    ...
    function Ee(n, t) {
        ...
        return function(i, u, a, o) {
            ...
            for (var c, l = a * t,
                     s = i; a > 0 ? s > u: u > s; s -= l) o.point((c = Lt([e, -r * Math.cos(s), -r * Math.sin(s)]))[0], c[1])
        }
    }
    function ke(n, t) {
        var e = qt(t);
    ...
    function ze() {
        function n(n, i) {
            var u = Math.sin(i *= Ka),
                ...
                o = Math.abs((n *= Ka) - t),
                c = Math.cos(o);
            Qo += Math.atan2(Math.sqrt((o = a * Math.sin(o)) * o + (o = r * u - e * a * c) * o), e * u + r * a * c),
                t = n,
                e = u,
                r = a
        }
    ...
    function Je(n, t) {
        ...
        if (e && (r += "Q" + (u[0] - 2 * a[0] / 3) + "," + (u[1] - 2 * a[1] / 3) + "," + u[0] + "," + u[1], i = n[1], c = 2), t.length > 1) {
            ...
            for (var l = 2; l < t.length; l++, c++) u = n[c],
                o = t[l],
    ...
    function Ge(n, t) {
        for (var e, r = [], i = (1 - t) / 2, u = n[0], a = n[1], o = 1, c = n.length; ++o < c;) e = u,
            u = a,
            a = n[o],
    ...
    function Qe(n) {
        ...
        for (var t, e = [], r = -1, i = n.length, u = [0], a = [0]; ++r < 3;) t = n[r],
            u.push(t[0]),
            a.push(t[1]);
        for (e.push(er(lc, u) + "," + er(lc, a)), --r; ++r < i;) t = n[r],
            u.shift(),
            u.push(t[0]),
            a.shift(),
            a.push(t[1]),
    ...
    function nr(n) {
        for (var t, e, r = -1,
            ...
            a.push(e[0]),
            o.push(e[1]);
        for (t = [er(lc, a), ",", er(lc, o)], --r; ++r < u;) e = n[r % i],
            a.shift(),
            a.push(e[0]),
            o.shift(),
            o.push(e[1]),
    ...
    function tr(n, t) {
        var e = n.length - 1;
        if (e) for (var r, i, u = n[0][0], a = n[0][1], o = n[e][0] - u, c = n[e][1] - a, l = -1; ++l <= e;) r = n[l],
            i = l / e,
            r[0] = t * r[0] + (1 - t) * (u + i * o),
            r[1] = t * r[1] + (1 - t) * (a + i * c);
        return Ke(n)
    ...
    function ur(n) {
        for (var t = 0,
                 e = n.length - 1,
                 r = [], i = n[0], u = n[1], a = r[0] = ir(i, u); ++t < e;) r[t] = (a + (a = ir(i = u, u = n[t + 1]))) / 2;
        return r[t] = a,
            r
    }
    function ar(n) {
        for (var t, e, r, i, u = [], a = ur(n), o = -1, c = n.length - 1; ++o < c;) t = ir(n[o], n[o + 1]),
            Math.abs(t) < 1e-6 ? a[o] = a[o + 1] = 0 : (e = a[o] / t, r = a[o + 1] / t, i = e * e + r * r, i > 9 && (i = 3 * t / Math.sqrt(i), a[o] = i * e, a[o + 1] = i * r));
        for (o = -1; ++o <= c;) i = (n[Math.min(c, o + 1)][0] - n[Math.max(0, o - 1)][0]) / (6 * (1 + a[o] * a[o])),
            u.push([i || 0, a[o] * i || 0]);
        return u
    }
    function or(n) {
    ...
    function hr(n, t) {
        ...
        for (var a, o, c, l, s, f, h, g, p, d, m, v, y, M = e.list.shift();;) if (u.empty() || (a = u.min()), M && (u.empty() || M.y < a.y || M.y == a.y && M.x < a.x)) o = r.leftBound(M),
            c = r.right(o),
            h = r.rightRegion(o),
            v = i.bisect(h, M),
    ...
    function vr(n, t) {
        ...
        var e = n.r,
            ...
            o = t.b - i;
        return function(t) {
            return n.r = Math.round(e + u * t),
                n.g = Math.round(r + a * t),
                n.b = Math.round(i + o * t),
                n
        }
    }
    function yr(n, t) {
    ...
    function xr(n, t) {
        var e, r, i, u, a, o = 0,
            ...
            l = [],
            s = [];
        for (n += "", t += "", hc.lastIndex = 0, r = 0; e = hc.exec(t); ++r) e.index && l.push(t.substring(o, c = e.index)),
            s.push({
                i: l.length,
                x: e[0]
            }),
        ...
        for (; u > r;) a = s.pop(),
            null == l[a.i + 1] ? l[a.i] = a.x: (l[a.i] = a.x + l[a.i + 1], l.splice(a.i + 1, 1)),
            u--;
        return 1 === l.length ? null == l[0] ? (a = s[0].x,
            function(n) {
                return a(n) + ""
            }) : function() {
            return t
    ...
    function Dr(n, t) {
        ...
        return arguments.length < 2 && (t = .45),
            arguments.length ? e = t / (2 * Wa) * Math.asin(1 / n) : (n = 1, e = t / 4),
            function(r) {
    ...
    function Yr(n) {
        ...
        t[0] * e[1] < e[0] * t[1] && (t[0] *= -1, t[1] *= -1, r *= -1, i *= -1),
            ...
            this.scale = [r, u],
            this.skew = u ? Math.atan2(i, u) * Qa: 0
    }
    function Rr(n, t) {
    ...
    function Wr(n, t) {
        if (n === t) return n;
        for (var e = $r(n), r = $r(t), i = e.pop(), u = r.pop(), a = null; i === u;) a = i,
            i = e.pop(),
            u = r.pop();
        return a
    }
    ...
    function ni(n, t, e) {
        var r = 0,
            i = 0;
        if (n.charge = 0, !n.leaf) for (var u, a = n.nodes,
                                            o = a.length,
                                            c = -1; ++c < o;) u = a[c],
        null != u && (ni(u, t, e), n.charge += u.charge, r += u.charge * u.cx, i += u.charge * u.cy);
        if (n.point) {
    ...
    function ti(n, t) {
        return da.rebind(n, t, "sort", "children", "value"),
            n.nodes = n,
            n.links = ui,
            n
    }
    ...
    function Si(n, t) {
        function e(n, r) {
            var i = n.children;
            if (i && (a = i.length)) for (var u, a, o = null,
                                              c = -1; ++c < a;) u = i[c],
                e(u, o),
                o = u;
            t(n, r)
    ...
    function $i(n, t, e, r) {
        ...
        for (n[o] < n[0] && (n = n.slice().reverse(), t = t.slice().reverse()); ++a <= o;) i.push(e(n[a - 1], n[a])),
            u.push(r(t[a - 1], t[a]));
        return function(t) {
    ...
    function Wi(n, t, e, r) {
        function i() {
            var i = Math.min(n.length, t.length) > 2 ? $i: Xi,
                c = r ? Zr: Xr;
            return a = i(n, t, c, e),
                o = i(t, n, c, br),
                u
    ...
    function tu(n, t, e) {
        ...
        return da.format(e ? e.replace(Mo,
            function(n, t, e, i, u, a, o, c, l, s) {
    ...
    function uu(n, t) {
        ...
        return e.domain = function(r) {
            ...
            n = [],
                u = new i;
            for (var a, o = -1,
                     c = r.length; ++o < c;) u.has(a = r[o]) || u.set(a, n.push(a));
    ...
    function du(n) {
        function t(t) {
            ...
            for (var h, g, p, d = [], m = [], v = [], y = -1, M = t.length, x = ht(e), b = ht(i), _ = e === r ?
                function() {
                    return g
                }: ht(r), w = i === u ?
                function() {
    ...
    function Eu(n, t, e, r) {
        ...
        if (!a) {
            ...
            return a = u[e] = {
                ...
                da.timer(function(r) {
                        function i(r) {
                            return u.active > e ? l() : (u.active = e, a.event && a.event.start.call(n, s, t), a.tween.forEach(function(e, r) { (r = r.call(n, s, t)) && p.push(r)
    ...
    function Tu(n, t, e) {
        ...
        function a(n, r, u) {
            var a = i(n),
                o = [];
            if (u > 1) for (; r > a;) e(a) % u || o.push(new Date( + a)),
                t(a, 1);
        ...
        return r.invert = function(t) {
            ...
            r.ticks = function(e, i) {
                ...
                if ("function" != typeof e) {
                    ...
                    Math.log(o / gl[c - 1]) < Math.log(gl[c] / o) && --c,
                        e = t[c],
                        i = e[1],
                        e = e[0].range
                }
    ...
    try {
        ...
        var xa = ya.Element.prototype,
            ba = xa.setAttribute,
            _a = xa.setAttributeNS,
            wa = ya.CSSStyleDeclaration.prototype,
            Sa = wa.setProperty;
    ...
    da.ascending = function(n, t) {
        ...
        da.median = function(t, e) {
            return arguments.length > 1 && (t = t.map(e)),
                t = t.filter(n),
                t.length ? da.quantile(t.sort(da.ascending), .5) : void 0
        },
    ...
    da.bisectLeft = Ea.left,
        da.bisect = da.bisectRight = Ea.right,
        da.shuffle = function(n) {
        ...
        da.zip = function() {
            ...
            for (var n = -1,
                     e = da.min(arguments, t), r = new Array(e); ++n < e;) for (var i, u = -1,
                                                                                    a = r[n] = new Array(i); ++u < i;) a[u] = arguments[u][n];
            return r
        },
        ...
        da.range = function(n, t, r) {
            ...
            var i, u = [],
                a = e(Math.abs(r)),
                o = -1;
            if (n *= a, t *= a, r *= a, 0 > r) for (; (i = n + r * ++o) > t;) u.push(i / a);
    ...
    da.nest = function() {
        function n(t, o, c) {
            ...
            for (var l, s, f, h, g = -1,
                     p = o.length,
                     d = a[c++], m = new i; ++g < p;)(h = m.get(l = d(s = o[g]))) ? h.push(s) : m.set(l, [s]);
        ...
        da.rebind = function(n, t) {
            for (var e, r = 1,
                     i = arguments.length; ++r < i;) n[e = arguments[r]] = a(n, t, t[e]);
            return n
        };
    var Na = ["webkit", "ms", "moz", "Moz", "o", "O"],
        qa = l;
    try {
    ...
    da.dispatch = function() {
        for (var n = new f,
                 t = -1,
                 e = arguments.length; ++t < e;) n[arguments[t]] = h(n);
        return n
    },
    ...
    Fa.select = function(n) {
        ...
        for (var a = -1,
            ...
            for (var c = -1,
                     l = r.length; ++c < l;)(i = r[c]) ? (t.push(e = n.call(i, i.__data__, c, a)), e && "__data__" in i && (e.__data__ = i.__data__)) : t.push(null)
        }
        return m(u)
    },
        Fa.selectAll = function(n) {
            ...
            n = y(n);
            for (var i = -1,
                     u = this.length; ++i < u;) for (var a = this[i], o = -1, c = a.length; ++o < c;)(e = a[o]) && (r.push(t = qa(n.call(e, e.__data__, o, i))), t.parentNode = e);
            return m(r)
        };
    var Pa = {
            ...
            function e(n, e) {
                ...
                if (t) {
                    var m, v = new i,
                        y = new i,
                        M = [];
                    for (r = -1; ++r < o;) m = t.call(u = n[r], u.__data__, r),
                        v.has(m) ? d[r] = u: v.set(m, u),
                        M.push(m);
                    for (r = -1; ++r < f;) m = t.call(e, a = e[r], r),
                        (u = v.get(m)) ? (g[r] = u, u.__data__ = a) : y.has(m) || (p[r] = A(a)),
                        y.set(m, a),
                        v.remove(m);
    ...
    var Oa = [];
    da.selection.enter = C,
        da.selection.enter.prototype = Oa,
        Oa.append = Fa.append,
        Oa.empty = Fa.empty,
        Oa.node = Fa.node,
        Oa.call = Fa.call,
        ...
        Oa.select = function(n) {
            for (var t, e, r, i, u, a = [], o = -1, c = this.length; ++o < c;) {
                ...
                for (var l = -1,
                         s = i.length; ++l < s;)(u = i[l]) ? (t.push(r[l] = e = n.call(i.parentNode, u.__data__, l, o)), e.__data__ = u.__data__) : t.push(null)
            }
            return m(a)
        },
        Oa.insert = function(n, t) {
            return arguments.length < 2 && (t = z(this)),
                Fa.insert.call(this, n, t)
        },
        Fa.transition = function() {
            for (var n, t, e = zc || ++Fc,
                ...
                r.push(n = []);
                for (var o = this[u], c = -1, l = o.length; ++c < l;)(t = o[c]) && Eu(t, c, e, i),
                    n.push(t)
            }
            return _u(r, e)
        },
    ...
    da.touches = function(n, t) {
            ...
            function r(n, t, e, r) {
                return function() {
                    ...
                    var c, l = this,
                        ...
                        d = t(s, g),
                        m = 0,
                        v = da.select(ya).on(e + "." + p, a).on(r + "." + p, o),
                        y = H();
                    u ? (c = u.apply(l, arguments), c = [c.x - d[0], c.y - d[1]]) : c = [0, 0],
                        f({
                            type: "dragstart"
                        })
                }
            }
            var i = d(n, "drag", "dragstart", "dragend"),
                u = null,
                a = r(s, da.mouse, "mousemove", "mouseup"),
        ...
        da.behavior.zoom = function() {
            ...
            function o() {
                ...
                function e() {
                    l.on(k, ya === r ? s: null).on(A, null),
                        h(c && da.event.target === o)
                }
                var r = this,
                    u = N.of(r, arguments),
                    o = da.event.target,
                    c = 0,
                    l = da.select(ya).on(k, n).on(A, e),
                    f = t(da.mouse(r)),
                    h = H()
            }
            function c() {
                function n() {
                    var n = da.touches(u),
                        ...
                        e = h[t.identifier];
                    if (c = n[1]) {
                        var c, l = h[c.identifier],
                            s = da.event.scale;
                        if (null == s) {
                            var f = (f = c[0] - t[0]) * f + (f = c[1] - t[1]) * f;
                            s = p && Math.sqrt(f / p)
                        }
                        t = [(t[0] + c[0]) / 2, (t[1] + c[1]) / 2],
                            e = [(e[0] + l[0]) / 2, (e[1] + l[1]) / 2],
                            r(s * m)
                    }
                    b = null,
                        i(t, e),
                ...
                var u = this,
                    ...
                    c = da.touches(u),
                    l = Date.now(),
                    s = "zoom-" + da.event.changedTouches[0].identifier,
                    f = "touchmove." + s,
                    d = "touchend." + s,
                    v = da.select(ya).on(f, n).on(d, e).on(E, null).on(k, null),
                    y = H();
                if (m = w, h = {},
                        p = 0, c.forEach(function(n) {
                        h[n.identifier] = t(n)
                    }), 1 === c.length) {
                    if (500 > l - b) {
                        var M = c[0],
            ...
            function l() {
                g(),
                h || (h = t(da.mouse(this))),
                    r(Math.pow(2, .002 * Xa()) * w),
                    i(da.mouse(this), h),
                    a(N.of(this, arguments))
            }
            function s() {
                h = null
            }
            function f() {
                ...
                r(Math.pow(2, da.event.shiftKey ? Math.ceil(u) - 1 : Math.floor(u) + 1)),
                    i(n, e),
                    a(N.of(this, arguments))
            }
            var h, p, m, v, y, M, x, b, _ = [0, 0],
                w = 1,
                S = Za,
                E = "mousedown.zoom",
                k = "mousemove.zoom",
    ...
    ao.brighter = function(n) {
        ...
        ao.darker = function(n) {
            return n = Math.pow(.7, arguments.length ? n: 1),
                it(Math.floor(n * this.r), Math.floor(n * this.g), Math.floor(n * this.b))
        },
        ao.hsl = function() {
    ...
    oo.forEach(function(n, t) {
        ...
        da.csv = da.dsv(",", "text/csv"),
        da.tsv = da.dsv("	", "text/tab-separated-values");
    var co, lo, so, fo;
    da.timer = function(n, t, e) {
        ...
        lo ? lo.next = i: co = i,
            lo = i,
        so || (fo = clearTimeout(fo), so = 1, ho(vt))
    },
        da.timer.flush = function() {
            yt(),
                Mt()
        };
    var ho = ya[o(ya, "requestAnimationFrame")] ||
            function(n) {
                setTimeout(n, 17)
            },
        go = ".",
        ...
        mo = [3, 3],
        vo = "$",
        yo = ["y", "z", "a", "f", "p", "n", "Âµ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(xt);
    da.formatPrefix = function(n, t) {
        var e = 0;
        return n && (0 > n && (n *= -1), t && (n = da.round(n, bt(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), e = Math.max( - 24, Math.min(24, 3 * Math.floor((0 >= e ? e + 1 : e - 1) / 3)))),
            yo[8 + e / 3]
    },
        ...
        da.format = function(n) {
            ...
            return function(n) {
                ...
                n = s(n, l);
                var m = n.lastIndexOf("."),
                    v = 0 > m ? n: n.substring(0, m),
                    y = 0 > m ? "": go + n.substring(m + 1); ! a && c && (v = bo(v));
    ...
    if (mo) {
        ...
        bo = function(n) {
            for (var t = n.length,
                     e = [], r = 0, i = mo[0]; t > 0 && i > 0;) e.push(n.substring(t -= i, t + i)),
                i = mo[r = (r + 1) % _o];
    ...
    da.geo = {},
        wt.prototype = {
            ...
            add: function(n) {
                St(n, this.t, wo),
                    St(wo.s, this.s, this),
                    this.s ? this.t += wo.t: this.s = wo.t
            },
            reset: function() {
                this.s = this.t = 0
            },
    ...
    var So = {
            ...
            FeatureCollection: function(n, t) {
                for (var e = n.features,
                         r = -1,
                         i = e.length; ++r < i;) Et(e[r].geometry, t)
            }
        },
        Eo = {
            Sphere: function(n, t) {
            ...
            MultiPolygon: function(n, t) {
                for (var e = n.coordinates,
                         r = -1,
                         i = e.length; ++r < i;) At(e[r], t)
            },
            GeometryCollection: function(n, t) {
                for (var e = n.geometries,
                         r = -1,
                         i = e.length; ++r < i;) Et(e[r], t)
            }
        };
    ...
    var ko, Ao = new wt,
        No = {
            ...
            polygonEnd: function() {
                var n = 2 * Ao;
                ko += 0 > n ? 4 * Wa + n: n,
                    No.lineStart = No.lineEnd = No.point = s
            }
        };
    da.geo.bounds = function() {
        ...
        var s, f, h, g, p, d, m, v, y, M, x, b = {
            ...
            polygonEnd: function() {
                No.polygonEnd(),
                    ...
                    b.lineStart = e,
                    b.lineEnd = r,
                    0 > Ao ? (s = -(h = 180), f = -(g = 90)) : y > Ja ? g = 90 : -Ja > y && (f = -90),
                    x[0] = s,
                    x[1] = h
            }
        };
        return function(n) {
            ...
            if (t) {
                ...
                for (var e, r = 1,
                    ...
                    l(e[0], i) || l(e[1], i) ? (o(i[0], e[1]) > o(i[0], i[1]) && (i[1] = e[1]), o(e[0], i[1]) > o(i[0], i[1]) && (i[0] = e[0])) : u.push(i = e);
                for (var a, e, p = -1 / 0,
                         t = u.length - 1,
                         r = 0,
                         i = u[t]; t >= r; i = e, ++r) e = u[r],
        ...
        da.geo.centroid = function(n) {
            qo = To = Co = zo = Do = jo = Lo = Ho = Fo = Po = Oo = 0,
                da.geo.stream(n, Yo);
            var t = Fo,
                e = Po,
                r = Oo,
    ...
    var qo, To, Co, zo, Do, jo, Lo, Ho, Fo, Po, Oo, Yo = {
        ...
        Ro = Xt(Ut, Jt, Kt, Qt),
        Uo = [ - Wa, 0],
        Io = 1e9; (da.geo.conicEqualArea = function() {
        return ie(ue)
    }).raw = ue,
        da.geo.albers = function() {
        ...
        da.geo.albersUsa = function() {
            ...
            var t, e, r, i, u = da.geo.albers(),
                a = da.geo.conicEqualArea().rotate([154, 0]).center([ - 2, 58.5]).parallels([55, 65]),
                o = da.geo.conicEqualArea().rotate([157, 0]).center([ - 3, 19.9]).parallels([8, 18]),
                c = {
                    point: function(n, e) {
                        t = [n, e]
                    }
            ...
            return n.invert = function(n) {
                ...
                n.translate = function(t) {
                    ...
                    return e = u.translate(t).clipExtent([[s - .455 * l, f - .238 * l], [s + .455 * l, f + .238 * l]]).stream(c).point,
                        r = a.translate([s - .307 * l, f + .201 * l]).clipExtent([[s - .425 * l + Ja, f + .12 * l + Ja], [s - .214 * l - Ja, f + .234 * l - Ja]]).stream(c).point,
                        i = o.translate([s - .205 * l, f + .212 * l]).clipExtent([[s - .214 * l + Ja, f + .166 * l + Ja], [s - .115 * l - Ja, f + .234 * l - Ja]]).stream(c).point,
                        n
                },
                n.scale(1070)
        };
    var Vo, Xo, Zo, Bo, $o, Wo, Jo = {
            ...
            polygonEnd: function() {
                Jo.lineStart = Jo.lineEnd = Jo.point = s,
                    Vo += Math.abs(Xo / 2)
            }
        },
        Go = {
    ...
    da.geo.path = function() {
        function n(n) {
            return n && ("function" == typeof o && u.pointRadius( + o.apply(this, arguments)), a && a.valid || (a = i(u)), da.geo.stream(n, a)),
                u.result()
        }
        function t() {
            return a = null,
        ...
        return n.area = function(n) {
            return Vo = 0,
                da.geo.stream(n, i(Jo)),
                Vo
        },
            n.centroid = function(n) {
                return Co = zo = Do = jo = Lo = Ho = Fo = Po = Oo = 0,
                    da.geo.stream(n, i(Ko)),
                    Oo ? [Fo / Oo, Po / Oo] : Ho ? [jo / Ho, Lo / Ho] : Do ? [Co / Do, zo / Do] : [0 / 0, 0 / 0]
            },
            n.bounds = function(n) {
                return $o = Wo = -(Zo = Bo = 1 / 0),
                    da.geo.stream(n, i(Go)),
                    [[Zo, Bo], [$o, Wo]]
            },
        ...
        da.geo.projection = ve,
        da.geo.projectionMutator = ye,
        (da.geo.equirectangular = function() {
            return ve(xe)
        }).raw = xe.invert = xe,
        da.geo.rotation = function(n) {
            function t(t) {
                return t = n(t[0] * Ka, t[1] * Ka),
                    t[0] *= Qa,
                    t[1] *= Qa,
                    t
            }
            return n = be(n[0] % 360 * Ka, n[1] * Ka, n.length > 2 ? n[2] * Ka: 0),
                t.invert = function(t) {
                    return t = n.invert(t[0] * Ka, t[1] * Ka),
                        t[0] *= Qa,
                        t[1] *= Qa,
                        t
                },
    ...
    var ec = De(function(n) {
        ...
        gt); (da.geo.azimuthalEquidistant = function() {
        return ve(ec)
    }).raw = ec,
        (da.geo.conicConformal = function() {
            return ie(je)
        }).raw = je,
        (da.geo.conicEquidistant = function() {
            return ie(Le)
        }).raw = Le;
    var rc = De(function(n) {
            return 1 / n
        },
        Math.atan); (da.geo.gnomonic = function() {
        return ve(rc)
    }).raw = rc,
    ...
    var ic = De(function() {
        ...
        Math.asin); (da.geo.orthographic = function() {
        return ve(ic)
    }).raw = ic;
    ...
    da.geom.hull = function(n) {
        function t(n) {
            ...
            var t, i, u, a, o, c, l, s, f, h, g, p, d = ht(e),
                m = ht(r),
                v = n.length,
                y = v - 1,
                M = [],
    ...
    sc.area = function() {
        ...
        sc.centroid = function(n) {
            var t, e, r = -1,
                ...
                a = 0,
                o = this[i - 1];
            for (arguments.length || (n = -1 / (6 * this.area())); ++r < i;) t = o,
                o = this[r],
                e = t[0] * o[1] - o[0] * t[1],
                u += (t[0] + o[0]) * e,
                a += (t[1] + o[1]) * e;
        ...
        sc.clip = function(n) {
            for (var t, e, r, i, u, a, o = fr(n), c = -1, l = this.length - fr(this), s = this[l - 1]; ++c < l;) {
                for (t = n.slice(), n.length = 0, i = this[c], u = t[(r = t.length - o) - 1], e = -1; ++e < r;) a = t[e],
                    lr(a, s, i) ? (lr(u, s, i) || n.push(sr(u, a, s, i)), n.push(a)) : lr(u, s, i) && n.push(sr(u, a, s, i)),
                    u = a;
                o && n.push(n[0]),
                    s = i
            }
        ...
        da.geom.delaunay = function(n) {
            ...
            return hr(n,
                ...
                t.forEach(function(t, r) {
                    ...
                    for (var o = 0,
                             c = t.length - 1; c > o; o++) e.push([i, t[o], t[o + 1]])
                }),
                e
        },
    ...
    da.geom.quadtree = function(n, t, e, r, i) {
        function u(n) {
            ...
            var s, f, h, g, p, d, m, v, y, M = ht(o),
                x = ht(c);
            if (null != t) d = t,
                m = e,
                v = r,
                y = i;
            else if (v = y = -(d = m = 1 / 0), f = [], h = [], p = n.length, a) for (g = 0; p > g; ++g) s = n[g],
            s.x < d && (d = s.x),
            s.y < m && (m = s.y),
            s.x > v && (v = s.x),
            s.y > y && (y = s.y),
            ...
            if (E.add = function(n) {
                    ...
                    g = -1, null == t) {
                for (; ++g < p;) u(E, n[g], f[g], h[g], d, m, v, y); --g
        ...
        da.interpolateRgb = vr,
        da.interpolateObject = yr,
        da.interpolateNumber = Mr,
        da.interpolateString = xr;
    var hc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
    da.interpolate = br,
        da.interpolators = [function(n, t) {
            var e = typeof t;
    ...
    da.ease = function(n) {
        ...
        return e = pc.get(e) || gc,
            r = dc.get(r) || gt,
            wr(r(e.apply(null, Array.prototype.slice.call(arguments, 1))))
    },
        da.interpolateHcl = Hr,
        da.interpolateHsl = Fr,
        da.interpolateLab = Pr,
        da.interpolateRound = Or,
        da.transform = function(n) {
    ...
    da.interpolateTransform = Vr,
        da.layout = {},
        da.layout.bundle = function() {
            return function(n) {
        ...
        da.layout.force = function() {
            ...
            return o.tick = function() {
                if ((r *= .99) < .005) return c.end({
                    ...
                    !0;
                var t, e, o, f, h, d, y, M, x, b = m.length,
                    _ = v.length;
                for (e = 0; _ > e; ++e) o = v[e],
                    f = o.source,
                    h = o.target,
                    M = h.x - f.x,
                    x = h.y - f.y,
                (d = M * M + x * x) && (d = r * u[e] * ((d = Math.sqrt(d)) - i[e]) / d, M *= d, x *= d, h.x -= M * (y = f.weight / (h.weight + f.weight)), h.y -= x * y, f.x += M * (y = 1 - y), f.y += x * y);
                if ((y = r * p) && (M = l[0] / 2, x = l[1] / 2, e = -1, y)) for (; ++e < b;) o = m[e],
                    o.x += (M - o.x) * y,
                    o.y += (x - o.y) * y;
                if (g) for (ni(t = da.geom.quadtree(m), r, a), e = -1; ++e < b;)(o = m[e]).fixed || t.visit(n(o));
                for (e = -1; ++e < b;) o = m[e],
                    o.fixed ? (o.x = o.px, o.y = o.py) : (o.x -= (o.px - (o.px = o.x)) * s, o.y -= (o.py - (o.py = o.y)) * s);
                c.tick({
                    type: "tick",
                    alpha: r
                })
                ...
                o.start = function() {
                    ...
                    var e, r, c, s, p = m.length,
                        d = v.length,
                        y = l[0],
                        M = l[1];
                    for (e = 0; p > e; ++e)(s = m[e]).index = e,
                        s.weight = 0;
                    for (e = 0; d > e; ++e) s = v[e],
                    "number" == typeof s.source && (s.source = m[s.source]),
                    "number" == typeof s.target && (s.target = m[s.target]),
                        ++s.source.weight,
                        ++s.target.weight;
                    for (e = 0; p > e; ++e) s = m[e],
                    isNaN(s.x) && (s.x = n("x", y)),
                    ...
                    isNaN(s.px) && (s.px = s.x),
                    isNaN(s.py) && (s.py = s.y);
                    if (i = [], "function" == typeof f) for (e = 0; d > e; ++e) i[e] = +f.call(this, v[e], e);
                    else for (e = 0; d > e; ++e) i[e] = f;
                    if (u = [], "function" == typeof h) for (e = 0; d > e; ++e) u[e] = +h.call(this, v[e], e);
                ...
                o.drag = function() {
                    return e || (e = da.behavior.drag().origin(gt).on("dragstart.force", Jr).on("drag.force", t).on("dragend.force", Gr)),
                        arguments.length ? (this.on("mouseover.force", Kr).on("mouseout.force", Qr).call(e), void 0) : e
                },
                da.rebind(o, c, "on")
        };
    var vc = 20,
    ...
    da.layout.hierarchy = function() {
        function n(t, a, o) {
            ...
            if (t.depth = a, o.push(t), c && (l = c.length)) {
                for (var l, s, f = -1,
                         h = t.children = [], g = 0, p = a + 1; ++f < l;) s = n(c[f], p, o),
                    s.parent = t,
                    h.push(s),
                    g += s.value;
                r && h.sort(r),
        ...
        da.layout.partition = function() {
            function n(t, e, r, i) {
                ...
                if (t.x = e, t.y = t.depth * i, t.dx = r, t.dy = i, u && (a = u.length)) {
                    var a, o, c, l = -1;
                    for (r = t.value ? r / t.value: 0; ++l < a;) n(o = u[l], e, c = o.value * r, i),
                        e += c
                }
            }
            function t(n) {
        ...
        da.layout.pie = function() {
            function n(u) {
                var a = u.map(function(e, r) {
                    ...
                    c = (("function" == typeof i ? i.apply(this, arguments) : i) - o) / da.sum(a),
                    l = da.range(u.length);
                null != e && l.sort(e === Mc ?
                    function(n, t) {
                        return a[t] - a[n]
    ...
    var xc = da.map({
            "inside-out": function(n) {
                var t, e, r = n.length,
                    i = n.map(fi),
                    u = n.map(hi),
                    a = da.range(r).sort(function(n, t) {
                        return i[n] - i[t]
                    }),
                    o = 0,
                    c = 0,
    ...
    da.layout.histogram = function() {
        function n(n, u) {
            for (var a, o, c = [], l = n.map(e, this), s = r.call(this, l, u), f = i.call(this, s, l, u), u = -1, h = l.length, g = f.length - 1, p = t ? 1 : 1 / h; ++u < g;) a = c[u] = [],
                a.dx = f[u + 1] - (a.x = f[u]),
                a.y = 0;
            if (g > 0) for (u = -1; ++u < h;) o = l[u],
            o >= s[0] && o <= s[1] && (a = c[da.bisect(f, o, 1, g) - 1], a.y += p, a.push(n[u]));
            return c
        }
        var t = !0,
            e = Number,
        ...
        da.layout.tree = function() {
            function n(n, u) {
                function a(n, t) {
                    var r = n.children,
                        i = n._tree;
                    if (r && (u = r.length)) {
                        for (var u, o, l, s = r[0], f = s, h = -1; ++h < u;) l = r[h],
                            a(l, o),
                            f = c(l, o, f),
                            o = l;
                        Ei(n);
                ...
                function c(n, t, r) {
                    if (t) {
                        for (var i, u = n,
                                 a = n,
                                 o = t,
                                 c = n.parent.children[0], l = u._tree.mod, s = a._tree.mod, f = o._tree.mod, h = c._tree.mod; o = Mi(o), u = yi(u), o && u;) c = yi(c),
                            a = Mi(a),
                            a._tree.ancestor = n,
                            i = o._tree.prelim + f - u._tree.prelim - l + e(o, u),
                        i > 0 && (ki(Ai(o, n, r), n, i), l += i, s += i),
                            f += o._tree.mod,
                            l += u._tree.mod,
                            h += c._tree.mod,
                            s += a._tree.mod;
                        o && !Mi(a) && (a._tree.thread = o, a._tree.mod += f - s),
                        u && !yi(c) && (c._tree.thread = u, c._tree.mod += l - h, r = n)
                    }
                    return r
                }
            ...
            var t = da.layout.hierarchy().sort(null).value(null),
                e = vi,
                r = [1, 1],
                i = !1;
        ...
        da.layout.pack = function() {
            function n(n, u) {
                ...
                return Li(o, c / 2, l / 2, t ? 1 : 1 / Math.max(2 * o.r / c, 2 * o.r / l)),
                    a
            }
            var t, e = da.layout.hierarchy().sort(Ni),
                r = 0,
                i = [1, 1];
        ...
        da.layout.treemap = function() {
            ...
            function t(e) {
                ...
                if (u && u.length) {
                    ...
                    for (n(h, l.dx * l.dy / e.value), s.area = 0; (c = h.length) > 0;) s.push(a = h[c - 1]),
                        s.area += a.area,
                        "squarify" !== g || (o = r(s, d)) <= p ? (h.pop(), p = o) : (s.area -= s.pop().area, i(s, d, l, !1), d = Math.min(l.dx, l.dy), s.length = s.area = 0, p = 1 / 0);
                    s.length && (i(s, d, l, !0), s.length = s.area = 0),
                        u.forEach(t)
                }
            }
            function e(t) {
                ...
                if (r && r.length) {
                    var u, a = f(t),
                        o = r.slice(),
                        c = [];
                    for (n(o, a.dx * a.dy / t.value), c.area = 0; u = o.pop();) c.push(u),
                        c.area += u.area,
                    null != u.z && (i(c, u.z ? a.dx: a.dy, a, !o.length), c.length = c.area = 0);
                    r.forEach(e)
                }
            }
            function r(n, t) {
                for (var e, r = n.area,
                         ...
                         u = 1 / 0,
                         a = -1,
                         o = n.length; ++a < o;)(e = n[a].area) && (u > e && (u = e), e > i && (i = e));
                return r *= r,
                    t *= t,
    ...
    var Ec = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
        ...
        da.svg.arc = function() {
            function n() {
                var n = t.apply(this, arguments),
                    ...
                    a = r.apply(this, arguments) + qc,
                    o = i.apply(this, arguments) + qc,
            ...
            return n.innerRadius = function(e) {
                ...
                n.centroid = function() {
                    var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2,
                        u = (r.apply(this, arguments) + i.apply(this, arguments)) / 2 + qc;
    ...
    Hc.call = Fa.call,
        ...
        Hc.node = Fa.node,
        Hc.size = Fa.size,
        da.transition = function(n) {
            return arguments.length ? zc ? n.transition() : n: Ya.transition()
        },
        da.transition.prototype = Hc,
        Hc.select = function(n) {
            var t, e, r, i = this.id,
                u = [];
            n = v(n);
            for (var a = -1,
        ...
        Hc.selectAll = function(n) {
            ...
            n = y(n);
            for (var c = -1,
                     l = this.length; ++c < l;) for (var s = this[c], f = -1, h = s.length; ++f < h;) if (r = s[f]) {
                u = r.__transition__[a],
                    e = n.call(r, r.__data__, f, c),
                    o.push(t = []);
                for (var g = -1,
                         p = e.length; ++g < p;)(i = e[g]) && Eu(i, g, a, u),
                    t.push(i)
            }
            return _u(o, a)
        },
        ...
        Hc.tween = function(n, t) {
            var e = this.id;
            return arguments.length < 2 ? this.node().__transition__[e].tween.get(n) : T(this, null == t ?
                function(t) {
        ...
        Hc.ease = function(n) {
            var t = this.id;
            return arguments.length < 1 ? this.node().__transition__[t].ease: ("function" != typeof n && (n = da.ease.apply(da, arguments)), T(this,
                function(e) {
        ...
        Hc.delay = function(n) {
            var t = this.id;
            return T(this, "function" == typeof n ?
                function(e, r, i) {
        ...
        Hc.each = function(n, t) {
            ...
            if (arguments.length < 2) {
                ...
                function(r) {
                    var i = r.__transition__[e]; (i.event || (i.event = da.dispatch("start", "end"))).on(n, t)
                });
            return this
        },
        Hc.transition = function() {
            for (var n, t, e, r, i = this.id,
                ...
                a.push(n = []);
                for (var t = this[o], l = 0, s = t.length; s > l; l++)(e = t[l]) && (r = Object.create(e.__transition__[i]), r.delay += r.duration, Eu(e, l, u, r)),
                    n.push(e)
            }
            return _u(a, u)
        },
        ...
        function n(u) {
            u.each(function() {
                ...
                a.style("pointer-events", "all").on("mousedown.brush", i).on("touchstart.brush", i),
                    ...
                    h.exit().remove(),
                o && (u = Vi(o), s.attr("x", u[0]).attr("width", u[1] - u[0]), e(a)),
                c && (u = Vi(c), s.attr("y", u[0]).attr("height", u[1] - u[0]), r(a)),
                    t(a)
            })
        }
        function t(n) {
        ...
        function i() {
            ...
            function p() {
                var n = i(),
                    u = !1;
                y && (n[0] += y[0], n[1] += y[1]),
                k || (da.event.altKey ? (v || (v = [(s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2]), N[0] = s[ + (n[0] < v[0])][0], N[1] = s[ + (n[1] < v[1])][1]) : v = null),
                S && d(n, o, 0) && (e(_), u = !0),
                E && d(n, c, 1) && (r(_), u = !0),
                u && (t(_), b({
                    type: "brush",
            ...
            function m() {
                p(),
                    ...
                    da.select("body").style("cursor", null),
            ...
            var v, y, M = this,
                ...
                A = H(),
                N = i(),
                q = da.select(ya).on("keydown.brush", l).on("keyup.brush", h);
            if (da.event.changedTouches ? q.on("touchmove.brush", p).on("touchend.brush", m) : q.on("mousemove.brush", p).on("mouseup.brush", m), k) N[0] = s[0][0] - N[0],
                N[1] = s[0][1] - N[1];
            else if (w) {
                var T = +/w$/.test(w),
                    C = +/^n/.test(w);
            ...
            _.style("pointer-events", "none").selectAll(".resize").style("display", null),
                da.select("body").style("cursor", x.style("cursor")),
                b({
                    type: "brushstart"
                }),
                p()
    ...
    var Vc = Date.prototype,
        Xc = "%a %b %e %X %Y",
        Zc = "%m/%d/%Y",
        Bc = "%H:%M:%S",
        $c = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
        Wc = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        Jc = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
        Gc = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
    da.time.year = Tu(function(n) {
            return n = da.time.day(n),
                n.setMonth(0, 1),
                n
        },
        function(n, t) {
        ...
        da.time.years = da.time.year.range,
        da.time.years.utc = da.time.year.utc.range,
        da.time.day = Tu(function(n) {
                var t = new Uc(2e3, 0);
        ...
        da.time.days = da.time.day.range,
        da.time.days.utc = da.time.day.utc.range,
        da.time.dayOfYear = function(n) {
        ...
        Ic.forEach(function(n, t) {
            ...
            var e = da.time[n] = Tu(function(n) {
                    return (n = da.time.day(n)).setDate(n.getDate() - (n.getDay() + t) % 7),
                        n
                },
                function(n, t) {
            ...
            da.time[n + "s"] = e.range,
                da.time[n + "s"].utc = e.utc.range,
                da.time[n + "OfYear"] = function(n) {
                    var e = da.time.year(n).getDay();
                    return Math.floor((da.time.dayOfYear(n) + (e + t) % 7) / 7)
                }
        }),
        da.time.week = da.time.sunday,
        da.time.weeks = da.time.sunday.range,
        da.time.weeks.utc = da.time.sunday.utc.range,
        da.time.weekOfYear = da.time.sundayOfYear,
        da.time.format = function(n) {
            function t(t) {
    ...
    da.time.format.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? ua: hl,
        ua.parse = function(n) {
            var t = new Date(n);
            return isNaN(t) ? null: t
        },
        ua.toString = hl.toString,
        da.time.second = Tu(function(n) {
        ...
        da.time.seconds = da.time.second.range,
        da.time.seconds.utc = da.time.second.utc.range,
        da.time.minute = Tu(function(n) {
        ...
        da.time.minutes = da.time.minute.range,
        da.time.minutes.utc = da.time.minute.utc.range,
        da.time.hour = Tu(function(n) {
        ...
        da.time.hours = da.time.hour.range,
        da.time.hours.utc = da.time.hour.utc.range,
        da.time.month = Tu(function(n) {
                return n = da.time.day(n),
                    n.setDate(1),
                    n
            },
        ...
        da.time.months = da.time.month.range,
        da.time.months.utc = da.time.month.utc.range;
    var gl = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
        pl = [[da.time.second, 1], [da.time.second, 5], [da.time.second, 15], [da.time.second, 30], [da.time.minute, 1], [da.time.minute, 5], [da.time.minute, 15], [da.time.minute, 30], [da.time.hour, 1], [da.time.hour, 3], [da.time.hour, 6], [da.time.hour, 12], [da.time.day, 1], [da.time.day, 2], [da.time.week, 1], [da.time.month, 1], [da.time.month, 3], [da.time.year, 1]],
        dl = [[da.time.format("%Y"), Ut], [da.time.format("%B"),
            function(n) {
                return n.getMonth()
            }], [da.time.format("%b %d"),
            function(n) {
    ...
    var yl = pl.map(function(n) {
        ...
        Ml = [[da.time.format.utc("%Y"), Ut], [da.time.format.utc("%B"),
            function(n) {
                return n.getUTCMonth()
            }], [da.time.format.utc("%b %d"),
            function(n) {
                return 1 != n.getUTCDate()
            }], [da.time.format.utc("%a %d"),
            function(n) {
                return n.getUTCDay() && 1 != n.getUTCDate()
            }], [da.time.format.utc("%I %p"),
            function(n) {
                return n.getUTCHours()
            }], [da.time.format.utc("%I:%M"),
            function(n) {
                return n.getUTCMinutes()
            }], [da.time.format.utc(":%S"),
            function(n) {
                return n.getUTCSeconds()
            }], [da.time.format.utc(".%L"),
            function(n) {
...
function sequence(nodes) {
    ...
    var svg = d3.select("body").append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).style("margin", "1em 0 1em " + -margin.left + "px");

    var g = svg.append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");

    var node = g.selectAll(".node").data(nodes).enter().append("g").attr("class",
        function(d) {
            return (d.type || "") + " node";
        }).attr("transform",
        function(d, i) {
    ...
    node.append("text").attr("x", 6).attr("dy", ".32em").text(function(d) {
        return d.name;
    }).each(function(d) {
        d.width = d.name ? this.getComputedTextLength() + 12 : 0;
    });

    node.insert("rect", "text").attr("ry", 6).attr("rx", 6).attr("y", -10).attr("height", 20).attr("width",
        function(d) {
            return d.width;
        });

    var link = g.selectAll(".link").data(d3.range(nodes.length - 1)).enter().insert("g", ".node").attr("class",
        function(i) {
            return (nodes[i + 1].type ? "to-" + nodes[i + 1].type + " ": " ") + (nodes[i].type ? "from-" + nodes[i].type + " ": " ") + " link";
        });

    link.append("path").attr("d",
        function(i) {
            return "M" + (i * step + nodes[i].width) + ",0H" + ((i + 1) * step - 11);
        });

    link.append("text").attr("x",
        function(i) {
            return (i + .5) * step + nodes[i].width / 2;
        }).attr("y", -6).style("text-anchor", "middle").text(function(i) {
        return nodes[i].link;
    });
